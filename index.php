...
<body>
    <div class="container mt-5 col-8">
        <div class="container mt-5 d-flex justify-content-center">
            ...
            <div id="dataWeather" style="display: none;"><img src="https://grazietravel.com/wp-content/uploads/2020/04/GettyImages-904523520-1-1.jpg" 
                class="card-img-top"><div class="card-body"><h5 class="card-title my-3 ">สถานที่ :London</h5><p class="card-text">อาทิตย์ขึ้นเวลา : 23:24:48</p><p class="card-text">อาทิตย์ตกเวลา : 11:07:21</p><p class="card-text">ความเร็วลม : 2.39</p><p class="card-text">อุณหภูมิ : 25.09</p><p class="card-text">ความชื้นในอากาศ : 86</p></div></div></div>
...
<script>
    ...
    function setDefault(){
        var urlDefualt = "https://api.openweathermap.org/data/2.5/weather?lat=51.5287352&lon=0.3817841&appid=585ebd9c6b56cac04e88cb2269a1cc6f";
        $.getJSON(urlDefualt)
            .done((data) => {
                ...
                var line = "<div id='dataWeather'>";
                    line += "<img src='https://grazietravel.com/wp-content/uploads/2020/04/GettyImages-904523520-1-1.jpg' class='card-img-top' ><div class='card-body'>"
